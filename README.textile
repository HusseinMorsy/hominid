...
The *Hominid::Base* class provides methods for retrieving the campaigns for a particular Mailchimp account, as well as creating new campaigns. The *Hominid::Campaign* class provides methods for working with a particular campaign.
...
Information on how to schedule a campaign
